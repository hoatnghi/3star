...
<html>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <h3>Three Star Investment Company</h3>
          <h4>Byaruhanga Prince</h4>
          <p>
            Kampala, Uganda<br>
            Africa<br>
          </p>
          <p><i class="fa fa-phone"></i> <abbr title="Phone">P</abbr>: +256758451176</p>
          <p><i class="fa fa-phone"></i> <abbr title="SMS">P</abbr>: +256782084205</p>
          <p><i class="fa fa-envelope-o"></i> <abbr title="Email">E</abbr>: <a href="mailto:admin@threestar.com">admin@threestar.com</a></p>
