                                            ...
                                            <div class="step-pane active" id="step1">
                                                ...
                                                <div class="step-content">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="icon-flag"></i>
                                                            <select class="form-control select2-input" name="countryCode" data-available="US,AG,AU" id="countryCode">
                                                ...
                                                <div class="step-content">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control input-mask-phone" type="text" id="phoneNumber" name="phoneNumber" />
                                                    </div>
                                                </div>
